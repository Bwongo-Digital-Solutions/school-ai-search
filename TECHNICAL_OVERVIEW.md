...
Each card carries the school name, student name, student number, class, and a QR code at error correction
level Q with a two-module quiet zone, drawn about 30mm square — comfortably within phone camera range.
