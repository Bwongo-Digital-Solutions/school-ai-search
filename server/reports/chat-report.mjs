...
const ROLE_LABELS = { user: 'Question', assistant: 'eSchool SchoolBot AI' };
...
export const buildChatReportPdf = async ({ school, themeColor, conversation, messages }) => {
  ...
  writer.gap(8);
  writer.text(
    'Generated by eSchool SchoolBot AI. Answers are drawn from school records and the curriculum library; ' +
      'check anything consequential against the source before acting on it. This report is not a substitute for professional advice.',
